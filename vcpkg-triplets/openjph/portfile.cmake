...
# openjph's AVX2 block encoder (ojph_block_encoder_avx2.cpp) hits an MSVC
# internal compiler error (C1001) when cross-compiled for the x86 (32-bit)
# target: the AVX2 source uses 64-bit intrinsics (_BitScanForward64) that are
# unavailable in 32-bit, which crashes the compiler. Disable the AVX2 code
# path on x86 only; x64 keeps the optimized AVX2 build.
set(_simd_options "")
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x86")
    set(_simd_options -DOJPH_DISABLE_AVX2=ON)
endif()
