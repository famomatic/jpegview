...
LRESULT CBatchCopyDlg::OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
	...
	m_lvFiles.InsertColumn(0, CNLS::GetString(_T("Old name")), LVCFMT_LEFT, HelpersGUI::ScaleToScreen(160));
	m_lvFiles.InsertColumn(1, CNLS::GetString(_T("Date")), LVCFMT_LEFT, HelpersGUI::ScaleToScreen(130));
	m_lvFiles.InsertColumn(2, CNLS::GetString(_T("New name (>> : file gets copied)")), LVCFMT_LEFT, HelpersGUI::ScaleToScreen(600));
